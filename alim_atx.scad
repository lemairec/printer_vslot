...
x2=2;
module alim_atx_support3(){
    difference(){
        union(){
            translate([-80, -20,0]) cube([160,110,e]);
            translate([-80, 0,0]) cube([160,90,e+5]);
        }
        translate([50,-10, -1]) cylinder(30, r=3);
        translate([-50,-10, -1]) cylinder(30, r=3);
        
        translate([-70, 10+x2,-1]) cube([135,65,e+2]);
        translate([0, x2,e]) rotate([90,0,180])alim_atx_3d();
    }
    %translate([0, x2,e]) rotate([90,0,180])alim_atx_3d();
}
